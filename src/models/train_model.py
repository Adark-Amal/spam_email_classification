...
class ModelTrainer(Preprocessor):
    ...
    def train(self, message_data: pd.DataFrame) -> None:
        """
        ...
        # Use separate run for each task
        ...
        with mlflow.start_run(run_name="Train Model"):
            ...
            # Create sub runs for random and grid search
            ...
            param_grid = {
                ...
                "classifier__max_depth": [
                    ...
                    (
                        best_params_random.get("classifier__max_depth", 10) + 5
                        if best_params_random.get("classifier__max_depth") is not None
                        else None
                    ),
                ],
            ...
            with mlflow.start_run(run_name="Log Evaluation Metrics"):
