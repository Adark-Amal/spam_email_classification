...
class Visualizer:
    ...
    def evaluation_report(self, model: object, X_train: np.array, y_train: np.array, X_test: np.array, y_test: np.array, label: list = ["ham", "spam"]) -> None:
        """
        ...
        visualizers = [
            ...
            PrecisionRecallCurve(model, classes=label, per_class=True, cmap="Set1", ax=axes[1, 0]),
