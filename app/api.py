...
# Load the trained model pipeline (this includes preprocessing and the classifier)
try:
...
class MessageInput(BaseModel):
    message: str = Field(..., min_length=1, max_length=1000, description="Message cannot be empty or too long.")
